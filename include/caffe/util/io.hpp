...
// multi-label
bool ReadFileToDatum(const string& filename, const vector<int> labels, Datum* datum);

inline bool ReadFileToDatum(const string& filename, Datum* datum) {
  vector<int> labels(-1, 1);
...
// multi-label
inline bool ReadImageToDatum(const string& filename, const vector<int> labels,
    const int height, const int width, const bool is_color, Datum* datum) {
